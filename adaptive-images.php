...
$resolutions   = array( 2400, 1800, 1600, 1400, 980, 768, 480 ); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "uploads/_cache"; // where to store the generated re-sized images. Specify from your document root!
